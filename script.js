  ...
  if (contactForm) {
    ...
    function getErrorMessage(field, rule) {
      ...
      const messages = {
        ...
        maxlength: 'Please enter no more than ' + field.getAttribute('data-maxlength') + ' characters.',
    ...
    function getOrCreateErrorEl(field) {
      ...
      let errorEl = contactForm.querySelector('[data-error-for="' + fieldId + '"]');

      if (!errorEl) {
        errorEl = document.createElement('span');
        errorEl.setAttribute('data-error-for', fieldId);
    ...
    function validateField(field) {
      ...
      if (!errorMessage && value.trim() !== '') {
        ...
        if (field.dataset.maxlength) {
          if (!VALIDATORS.maxlength(value, field.dataset.maxlength)) {
            errorMessage = getErrorMessage(field, 'maxlength');
          }
        }
      }
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '63b20246-0f09-4905-8725-e600d1566704',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '63b20246-0f09-4905-8725-e600d1566704';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '63b20246-0f09-4905-8725-e600d1566704';
